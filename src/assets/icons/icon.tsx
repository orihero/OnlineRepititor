  ...
  return (
    <Svg width={27} height={27} viewBox="0 0 27 27" fill="none">
      <Path
        ...
        fill={props.isFocused ? '#29CB73' : '#B5B5B5'}
      />
    </Svg>
  );
}
  ...
  return (
    <Svg width={23} height={29} viewBox="0 0 23 29" fill="none">
      <Path
        ...
        stroke={props.isFocused ? '#29CB73' : '#B5B5B5'}
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
      />
...
export function StarIcon({filled = false}) {
  let props = filled ? {fill: '#29CB73'} : {stroke: '#29CB73', strokeWidth: 1};
  return (
...
export function RadiusIcon() {
  return (
    <Svg width={8} height={8} viewBox="0 0 8 8" fill="none">
      <Circle cx={4} cy={4} r={4} fill="#29CB73" />
    </Svg>
  );
}
